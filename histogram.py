########################################################################
#  Task:     This script generates a human readable histogram          #
#            in a .png format from the vowpal wabbit varinfo           #
#            output.                                                   #
#                                                                      #
#  Input: vowpal wabbit varinfo output file                            #
#  Output: Shows feature Histogram Image                               #
########################################################################
...
varinfo_vw_loc = "varinfo/result.varinfo.vw"
...
################ Formating Data For Above Generated Graph ##############
	
with open(varinfo_vw_loc) as infile:
	d = {}
